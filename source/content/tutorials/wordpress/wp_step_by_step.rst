...
Before we configure Varnish to handle all the web traffic that comes to our WordPress site,
...
that are documented thoroughly in the :ref:`Varnish Tutorial <varnish>` in
...
Ignore cookies by default. Varnish will not cache content for requests including the cookie or
...
Whenever existing content in WordPress is updated, Varnish HTTP purge
...
many resources online and Varnish has an active community behind it ready to help. If you
