...
1. Modify **varnish** config file
	...
	- Otherwise you can browse down to alternative 2 and change port to 80. 
By default it is bound to port 6081.
...
2. Modify **default.vcl** file
	...
	- The value of .host by default is the localhost. It should replaces with the fully qualified host name 
or IP address (typically, a webserver) and listen port of the Varnish backend or origin server; that is, the server providing 
